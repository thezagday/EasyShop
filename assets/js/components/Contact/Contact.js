            ...
            <div className="container-fluid tm-mt-60">
                <div className="row tm-mb-50">
                    <div className="col-lg-4 col-12 mb-5">
                        <h2 className="tm-text-primary mb-5">{t('contact.title')}</h2>
                        <form id="contact-form" action="" method="POST" className="tm-contact-form">
                            <div className="form-group">
                                <input type="text" name="name" className="form-control rounded-0" placeholder={t('contact.name')} required/>
                            </div>
                            <div className="form-group">
                                <input type="email" name="email" className="form-control rounded-0" placeholder={t('contact.email')} required/>
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                <textarea rows="8" name="message" className="form-control rounded-0" placeholder={t('contact.message')} required></textarea>
                            </div>
                    ...
                    <div className="col-lg-4 col-12 mb-5">
                        <div className="tm-address-col">
                            <h2 className="tm-text-primary mb-5">{t('contact.address')}</h2>
                    ...
                    <div className="col-lg-4 col-12">
                        <h2 className="tm-text-primary mb-5">{t('contact.on_map')}</h2>
                ...
                <div className="row tm-mb-74 tm-people-row">
                    <div className="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                        ...
                        <h3 className="tm-text-secondary h5 mb-4">{t('contact.ceo')}</h3>
                        <p className="mb-4">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                        ...
                        <h3 className="tm-text-secondary h5 mb-4">{t('contact.muse')}</h3>
                        <p className="mb-4">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                        ...
                        <h3 className="tm-text-secondary h5 mb-4">{t('contact.cartographer')}</h3>
                        <p className="mb-4">
                            Sed faucibus nec velit finibus accumsan. Sed varius augue et leo pharetra, in varius
                            lacus eleifend. Quisque ut eleifend lacus.
                        </p>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                        ...
                        <h3 className="tm-text-secondary h5 mb-4">{t('contact.intern')}</h3>
                        <p className="mb-4">
                            Sed faucibus nec velit finibus accumsan. Sed varius augue et leo pharetra, in varius
                            lacus eleifend. Quisque ut eleifend lacus.
                        </p>
